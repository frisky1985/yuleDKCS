...
PC 上位机
  │
  ├── USB/UART ────── S32K312 EVB (调试串口, 日志输出)
...
| 测试角色 | 物理设备 | 作用 |
|----------|----------|------|
| DUT (Device Under Test) | S32K312 EVB + 所有模块 | 被测嵌入式系统 |
...
|------|------|----------|------|------|---------|
| 1 | 开发板 | NXP S32K312 EVB | 2 | 主 DUT + 备用 | $800 |
...
│                                                              │
│  PC (上位机)                                                  │
│   ├── USB ── J-Link ── SWD ── S32K312 EVB                     │
│   ├── USB ── UART  ── S32K312 Debug Console                    │
│   ├── USB ── nRF52840 DK (BLE Sniffer)                      │
