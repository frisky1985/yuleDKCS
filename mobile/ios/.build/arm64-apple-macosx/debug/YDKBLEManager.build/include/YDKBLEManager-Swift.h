...
#ifndef YDKBLEMANAGER_SWIFT_H
#define YDKBLEMANAGER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="YDKBLEManager",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// <ol>
///   <li>
///     扫描车辆 — 按协议 service UUID 过滤 (控制器级) + 广告包解析 (2b-A) 二次过滤
///   </li>
///   <li>
///     连接车辆 — 从扫描结果按 vehicleId 匹配 peripheral
///   </li>
///   <li>
///     发送解锁/锁车/启动指令 — 两阶段控制流 (写入 withResponse → 等待车辆 notify 响应)
///   </li>
///   <li>
///     读取车辆状态
///   </li>
...
/// 测试: 通过 <code>init(central:)</code> 注入 fake central/peripheral (见 Tests)。
SWIFT_CLASS("_TtC13YDKBLEManager13YDKBLEManager")
@interface YDKBLEManager : NSObject
